...
$(document).on('click', '#recycleBinLogbook', function () {
      ...
      $('#detailPrioritasLogbookTrash').html(`${prioritas == "Tinggi" ? `<span class="text-danger">${prioritas}</span>` : `<span class="text-warning">${prioritas}</span>`}`);
    ...
    evidenstrash.forEach(function(eviden) {
        $('#detailEvidensLogbookTrash').append(`<div class="col-4 d-flex flex-wrap">
