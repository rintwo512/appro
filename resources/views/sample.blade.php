            ...
            <div class="col-md-6">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Menentukan Kapasitas AC Dengan BTU</h3>
                    </div>
                    <div class="box-body">
                        <p class="mt-2">BTU/h (British Thermal Unit per hour), Bisa dikatakan daya pendingin ac, BTU menyatakan
                            kemampuan mengurangi panas / mendinginkan ruangan dengan luas dan kondisi tertentu selama 1 jam. Daya
                        ...
                        <div class="pasang-ac-custom-column" id="pasang_ac_column_tipe">
                            <div style="margin-bottom:0px;" class="pasang-ac-value-ladder">
                                <div class="form-group onoffswitch">
                                    <label>
                                        <input type="checkbox" class="onoffswitch-checkbox" id="on_off_advanced" name="on_off_advanced">
                                        Advanced Mode
                                    </label>
                                ...
                                <div class="form-group">
                                    <label id="pasang_ac_range_output" class="text-primary" style="font-size: 20px"></label>
                                    <input type="range" min="3" max="100" value="3" class="slider form-range" id="myRange">
                                </div>
                                <div class="form-group">
                                    <label id="pasang_ac_range_output_lebar" class="text-primary" style="font-size: 20px"></label>
                                ...
                                <div class="form-group" style="display:none" id="advanced_mode_container">
                                    <label id="pasang_ac_range_output_plafon" class="text-primary" style="font-size: 20px"></label>
                                    ...
                                    <div style="text-align:left" class="mb-2">
                                        ...
                                        <div class="advanced-column mb-3">
                                            ...
                                            <label><input type="radio" class="advanced-radio"
                                                          name="radio_aktivitas" value="low" /> Santai &nbsp;</label>
                                            <label><input type="radio" class="advanced-radio"
                                                          name="radio_aktivitas" value="medium" /> Office &nbsp;</label>
                                            <label><input type="radio" class="advanced-radio"
                                                          name="radio_aktivitas" value="high" />Olahraga</label>
                                        </div>
                                        ...
                                        <div class="advanced-column mb-3">
                                            <div class="pasang-ac-value-ladder-title"><b>Jenis Lampu Yang
                                                    digunakan</b></div>
                                            <label><input type="radio" class="advanced-radio"
                                                          name="radio_lampu" value="low" /> LED &nbsp;</label>
                                            <label><input type="radio" class="advanced-radio"
                                                          name="radio_lampu" value="medium" /> Neon &nbsp;</label>
                                            <label><input type="radio" class="advanced-radio"
                                                          name="radio_lampu" value="high" /> Spot Light</label>
                                        </div>
                                        ...
                                        <div class="advanced-column mb-3">
                                            ...
                                            <label><input type="radio" class="advanced-radio"
                                                          name="radio_glass" value="low" /> Low-E Double Glass
                                                &nbsp;</label>
                                            <label><input type="radio" class="advanced-radio"
                                                          name="radio_glass" value="medium" /> Double Glass
                                                &nbsp;</label>
                                            <label><input type="radio" class="advanced-radio"
                                                          name="radio_glass" value="high" /> Clear</label>
                                        </div>
                                    </div>
                                </div>
                                <div
                                    class="d-flex justify-content-center btn btn-primary hitung-button pasang-ac-button my-2">
                                    Hitung
                                </div>
