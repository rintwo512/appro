    ...
    <div class="fixed-profile p-3 mx-4 mb-2 bg-secondary-subtle rounded mt-3">
      <div class="hstack gap-3">
        ...
        <form action="{{ route('logout', ['id' => auth()->user()->id]) }}" method="post" id="autoLogout">
          @csrf
        <button class="border-0 bg-transparent text-primary ms-auto" tabindex="0" type="button" aria-label="logout" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="logout" id="btnLog">
