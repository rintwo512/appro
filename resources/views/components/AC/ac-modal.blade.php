<!-- Modal -->
<div class="modal fade" id="modalDetailAC" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="scroll-long-inner-modal" aria-hidden="true">
      <div class="modal-dialog modal-dialog-scrollable modal-lg"> 
        <div class="modal-content">
          ...
          <div class="modal-body">
            <ul class="list-group">
                  <li class="list-group-item d-flex justify-content-between align-items-center">Updated at <strong class="pull-right" id="detailUpdatedAC"></strong>                  
                  <li class="list-group-item d-flex justify-content-between align-items-center">ID <strong class="pull-right" id="detailIDAC" class="text-capitalize"></strong>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-center">Asset <strong class="pull-right" id="detailAssetsAC" class="text-capitalize"></strong>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-center">Wing <strong class="pull-right" id="detailWingAC"></strong>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-center">Lantai <strong class="pull-right" id="detailLantaiAC"></strong>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-center">Ruangan <strong class="pull-right" id="detailRuanganAC" class="text-capitalize"></strong>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-center">Merk <strong class="pull-right" id="detailMerkAC"></strong>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-center">Status <strong class="pull-right" id="detailStatusAC"></strong>
                  </li>
                            ...
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                              ...
                              <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                          <a class="dropdown-item dropdown-detail" id="dropdown1-tab" href="#dropdown1" role="tab" data-bs-toggle="tab" aria-controls="dropdown1">Case</a>
                                        </li>
                                        <li>
                                          <a class="dropdown-item dropdown-detail" id="dropdown2-tab" href="#dropdown2" role="tab" data-bs-toggle="tab" aria-controls="dropdown2">Keterangan</a>
                                        </li>
                                        <li>
                                          <a class="dropdown-item dropdown-detail" id="dropdown3-tab" href="#dropdown3" role="tab" data-bs-toggle="tab" aria-controls="dropdown3">Catatan</a>
                                        </li>   
                                </ul>
                              </li>
                            </ul>
