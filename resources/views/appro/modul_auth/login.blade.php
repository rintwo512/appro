      ...
      <div class="position-relative z-index-5">
        <div class="row">
          <div class="col-xl-7 col-xxl-8">
            <a href="" class="text-nowrap logo-img d-block px-4 py-9 w-100 animate__animated animate__backInLeft">
              <img src="{{ asset('/assets/images/logos/logo.svg') }}" class="dark-logo" alt="Logo-Dark" />
              
            </a>
            <div class="d-none d-xl-flex align-items-center justify-content-center h-n80 animate__animated animate__backInUp">
                ...
                <form method="post" action="{{ route('login.post') }}">
                  ...
                  <label for="login" class="form-label">NIK or Email</label>
                    <div class="input-group mb-3">
                      <input type="number" class="form-control @error('login') is-invalid @enderror" id="login" name="login">
                      <button class="btn bg-primary-subtle text-primary rounded-start-0 rounded-end" type="button" id="toggleUsername"><i class='bx bxs-calculator'></i></button>
                      @error('login')
                  ...
                  <label for="password" class="form-label">Password</label>
                    <div class="input-group mb-3">
                      ...
                      <button class="btn bg-primary-subtle text-primary rounded-start-0 rounded-end" type="button" id="togglePassword"><i class='bx bxs-show'></i></button>
                      @error('password')
                      <div class="invalid-feedback">
                          {{ $message }}
                      </div>
