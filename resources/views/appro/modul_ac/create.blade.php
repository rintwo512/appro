             ...
             <div class="card">
                  ...
                  <div class="card-body">
                      ...
                      <div class="row mt-4">
                        <div class="col-md-4">
                          ...
                          <input type="text"
                                ...
                                id="id_ac" name="id_ac" value="{{ old('id_ac') }}" placeholder="Contoh : 001">
                          @error('id_ac')
                          <div class="invalid-feedback">
                            {{ $message }}
                          </div>
                    ...
                    <div class="col-md-4">
                      ...
                      <input type="text" class="form-control @error('ruangan') is-invalid @enderror"
                             name="ruangan" id="ruangan" value="{{ old('ruangan') }}" placeholder="Contoh : Rg.GM GSD">
                      @error('ruangan')
                      <div class="invalid-feedback">
                        {{ $message }}
                      </div>
                  ...
                  <div class="col-md-4">
                    ...
                    <div class="input-group mb-3">
                      <input type="text" class="form-control @error('current') is-invalid @enderror" name="current" id="current" value="{{ old('current') }}" placeholder="Contoh : 4">
                  ...
                  <div class="col-md-4">
                    ...
                    <div class="input-group">
                        <input type="text"
                               ...
                               value="{{ old('daya_pendingin') }}" oninput="formatCurrency(this)"
                    ...
                    <div class="row mt-4">
                      <div class="col-md-3">
                        ...
                        <input type="text"
                        class="form-control"
                        name="product" id="product" value="{{ old('product') }}" placeholder="Contoh : Thailand">
                        @error('product')                
                          <div class="invalid-feedback">
                            {{ $message }}
                          </div>
                    ...
                    <div class="col-md-3">
                      ...
                      <input type="text"
                             ...
                             name="seri_indoor" id="seriIndoor" value="{{ old('seri_indoor') }}" placeholder="Contoh : RC25NV14">
                      @error('seri_indoor')
                      <div class="invalid-feedback">
                        {{ $message }}
                      </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" class="form-control @error('seri_outdoor') is-invalid @enderror"
                               name="seri_outdoor" id="seriOutdoor" value="{{ old('seri_outdoor') }}" placeholder="Contoh : FTC25NV14">
                        @error('seri_outdoor')
                        <div class="invalid-feedback">
                          {{ $message }}
                        </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" class="form-control"
                               name="berat_indoor" id="beratIndoor" value="{{ old('berat_indoor') }}" placeholder="Contoh : 14" oninput="formatCurrency(this)">
                        @error('berat_indoor')
                        <div class="invalid-feedback">
                          {{ $message }}
                        </div>
                    ...
                    <div class="row mt-4">
                      <div class="col-md-4">
                        ...
                        <input type="text" class="form-control"
                               name="berat_outdoor" id="beratOutdoor" value="{{ old('berat_outdoor') }}" placeholder="Contoh : 35" oninput="formatCurrency(this)">
                        @error('berat_outdoor')
                        <div class="invalid-feedback">
                          {{ $message }}
                        </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control"
                               name="dimensi_indoor" id="dimensiIndoor" value="{{ old('dimensi_indoor') }}" placeholder="Contoh : 28cm x 77cm x 22cm">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control"
                               name="dimensi_outdoor" id="dimensiOutdoor" value="{{ old('dimensi_outdoor') }}" placeholder="Contoh : 59cm x 84cm x 30cm">
                    ...
                    <div class="row mt-4">
                      <div class="col-md-4">
                        ...
                        <input type="text" class="form-control"
                               name="kebisingan_indoor" id="kebisinganindoor" value="{{ old('kebisingan_indoor') }}" placeholder="Contoh : 42/26/19">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control"
                               name="kebisingan_outdoor" id="kebisinganOutdoor" value="{{ old('kebisingan_outdoor') }}" placeholder="Contoh : 46/43">
                    ...
                    <div class="row mt-4">
                      <div class="col-md-6">
                        ...
                        <textarea class="form-control @error('kerusakan') is-invalid @enderror"
                                  ...
                                  placeholder="Contoh : E3 / Kekurangan freon"></textarea>
                        @error('kerusakan')
                        <div class="invalid-feedback">
                          {{ $message }}
                        </div>
                    ...
                    <div id="colKeterangan" class="col-md-6">
                        ...
                        <textarea class="form-control @error('keterangan') is-invalid @enderror"
                                  ...
                                  placeholder="Sudah tidak bisa diperbaiki"></textarea>
                        @error('keterangan')
                        <div class="invalid-feedback">                          
                            {{ $message }}                          
                        </div>
                    ...
                    <div class="col-md-12 mt-4">
                        ...
                        <textarea class="form-control @error('catatan') is-invalid @enderror" name="catatan"
                                  ...
                                  placeholder="Butuh penggantian AC baru"></textarea>
                        @error('catatan')
                        <div class="invalid-feedback">
                          {{ $message }}
                        </div>
