    ...
    <div class="container-fluid">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item">
                                    <a class="text-muted text-decoration-none" href="{{ route('index.ac') }}">Data
                                        AC</a>
                                </li>
        ...
        <div class="card">
            <div class="border-bottom title-part-padding">
                <h4 class="card-title mb-0"><a href="{{ route('index.ac') }}" class="btn btn-danger btn-sm"><i
                            class='bx bx-left-arrow-alt'></i> Kembali</a></h4>
            </div>
            <div class="card-body">
                <form novalidate="" action="{{ route('ac.create.post') }}" method="post">
                    @csrf
                    <div class="row mt-4">
                        <div class="col-md-4">
                            <div class="mb-3 form-group">
                                ...
                                <div class="controls">
                                    <input type="text"
                                        ...
                                        name="tgl_pemasangan" id="mdate2" value="{{ old('tgl_pemasangan') }}">
                            ...
                            <div class="mb-3 form-group">
                                ...
                                <div class="controls">
                                    <input type="text" data-role="tagsinput" class="form-control"
                                        ...
                                        value="{{ old('petugas_pemasangan') }}" placeholder="Contoh : nama1, nama2,">
                        ...
                        <div class="col-md-4">
                            <div class="mb-3 form-group">
                                ...
                                <div class="controls">
                                    <input class="form-control" type="text" name="tgl_maintenance" id="mdate"
                    ...
                    <div class="row mt-4">
                        <div class="col-md-12">
                            <div class="col-md-12" style="margin-bottom: 10px">
                                ...
                                <select class="form-control" data-placeholder="Choose anything" multiple="multiple"
                                    name="petugas_maint[]" data-placeholder="Select a State" style="width: 100%;"
                                    id="select2-with-tags">
                                    <option value="" disabled>--Select--</option>
                                    @foreach ($petugas as $petug)
                                        <option value="{{ $petug }}">{{ $petug }}</option>
                                    @endforeach
                                </select>
                                @error('petugas_maint')
                    ...
                    <div class="row mt-4">
                        <div class="col-md-4">
                            ...
                            <input type="text"
                                class="form-control text-capitalize @error('id_ac') is-invalid @enderror" id="id_ac"
                                name="id_ac" value="{{ old('id_ac') }}" placeholder="Contoh : 001">
                            @error('id_ac')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control @error('asset') is-invalid @enderror"
                                name="asset" id="asset" value="{{ old('asset') }}" placeholder="Contoh : GSD">
                            @error('asset')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <select class="form-control @error('merk') is-invalid @enderror" id="merk"
                                name="merk">
                    ...
                    <div class="row mt-4">
                        <div class="col-md-4">
                            ...
                            <select class="form-control @error('wing') is-invalid @enderror" id="wing"
                                name="wing">
                                <option selected disabled value="">--Select--</option>
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-md-4">
                            <label for="daya_pk" class="form-label">Daya PK <span
                                    class="text-danger">*</span></label>
                            <select class="form-control @error('daya_pk') is-invalid @enderror" id="daya_pk"
                                name="daya_pk">
                                <option selected disabled value="">--Select--</option>
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-md-4">
                            ...
                            <select class="form-control @error('pipa') is-invalid @enderror" id="pipa"
                                name="pipa">
                                <option selected disabled value="">--Select--</option>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group mb-3">
                                <input type="text" class="form-control @error('current') is-invalid @enderror"
                                    name="current" id="current" value="{{ old('current') }}"
                                    placeholder="Contoh : 4">
                                <div class="input-group-append">
                                    <select id="currentSatuan" class="form-control" name="current_satuan">
                    ...
                    <div class="row mt-4">
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                <input type="text"
                                    ...
                                    name="daya_listrik" value="{{ old('daya_listrik') }}"
                                    oninput="formatCurrency(this)" id="dayaListrik" placeholder="Contoh : 21.000">
                                <div class="input-group-append">
                                    <select id="dayaListrikSatuan" class="form-control" name="daya_listrik_satuan">
                        ...
                        <div class="col-md-4">
                            ...
                            <select class="form-control @error('phase') is-invalid @enderror" id="phase"
                                name="phase">
                                <option selected disabled value="">--Select--</option>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                <input type="text"
                                    ...
                                    name="daya_pendingin" id="daya_pendingin" value="{{ old('daya_pendingin') }}"
                                    oninput="formatCurrency(this)" id="dayaPendingin" placeholder="Contoh : 5.000">
                                <div class="input-group-append">
                                    <select id="dayaPendinginSatuan" class="form-control"
                                        name="daya_pendingin_satuan">
                    ...
                    <div class="row mt-4">
                        <div class="col-md-3">
                            ...
                            <input type="text" class="form-control" name="product" id="product"
                                value="{{ old('product') }}" placeholder="Contoh : Thailand">
                            @error('product')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" class="form-control @error('seri_indoor') is-invalid @enderror"
                                name="seri_indoor" id="seriIndoor" value="{{ old('seri_indoor') }}"
                                placeholder="Contoh : RC25NV14">
                            @error('seri_indoor')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" class="form-control" name="berat_indoor" id="beratIndoor"
                                value="{{ old('berat_indoor') }}" placeholder="Contoh : 14"
                    ...
                    <div class="row mt-4">
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control" name="berat_outdoor" id="beratOutdoor"
                                value="{{ old('berat_outdoor') }}" placeholder="Contoh : 35"
                                oninput="formatCurrency(this)">
                            @error('berat_outdoor')
                                <div class="invalid-feedback">
                                    {{ $message }}
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control" name="dimensi_indoor" id="dimensiIndoor"
                                value="{{ old('dimensi_indoor') }}" placeholder="Contoh : 28cm x 77cm x 22cm">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control" name="dimensi_outdoor" id="dimensiOutdoor"
                                value="{{ old('dimensi_outdoor') }}" placeholder="Contoh : 59cm x 84cm x 30cm">
                    ...
                    <div class="row mt-4">
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control" name="kebisingan_indoor"
                                id="kebisinganindoor" value="{{ old('kebisingan_indoor') }}"
                                placeholder="Contoh : 42/26/19">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control" name="kebisingan_outdoor"
                                id="kebisinganOutdoor" value="{{ old('kebisingan_outdoor') }}"
                                placeholder="Contoh : 46/43">
                    ...
                    <div class="row mt-4">
                        <div class="col-md-6">
                            ...
                            <textarea class="form-control @error('kerusakan') is-invalid @enderror" name="kerusakan" id="kerusakan"
                                rows="4" cols="4" value="{{ old('kerusakan') }}" placeholder="Contoh : E3 / Kekurangan freon"></textarea>
                            @error('kerusakan')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
