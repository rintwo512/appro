                ...
                <div class="card-body">
                    ...
                    <div class="btn-toolbar mb-3" role="toolbar" aria-label="Toolbar with button groups">
                        <div class="btn-group me-2 mb-2" role="group" aria-label="First group">
                            <a href="{{ route('index.ac') }}" class="btn btn-secondary" data-bs-toggle="tooltip"
                                data-bs-placement="top" data-bs-original-title="Kembali">
                                <i class='bx bx-left-arrow-alt fs-4'></i>
                            </a>
                            <a href="{{ route('ac.hapus.permanent') }}" class="btn btn-secondary"
                                data-bs-toggle="tooltip" data-bs-placement="top"
                                data-bs-original-title="Hapus Semua Data" id="btnDeletePermanent">
                                    ...
                                    <tr>
                                        ...
                                        <td class="wrap-text">
                                            ...
                                            <button class="btn btn-info btn-sm" id="recycleBin" data-bs-toggle="modal"
                                                ...
                                                data-idac="{{ $ac->id_ac }}" data-assetac="{{ $ac->asset }}"
                                                data-wingac="{{ $ac->wing }}" data-lantaiac="{{ $ac->lantai }}"
                                                data-ruanganac="{{ $ac->ruangan }}" data-merkac="{{ $ac->merk }}"
                                                data-typeac="{{ $ac->type }}" data-jenisac="{{ $ac->jenis }}"
                                                ...
                                                data-tanggalmaintenanceac="{{ Illuminate\Support\Carbon::parse($ac->tgl_maintenance)->locale('id')->diffForHumans() }}"
                                                data-deleted="{{ $ac->is_delete }}/{{ Illuminate\Support\Carbon::parse($ac->deleted_at)->diffForHumans() }}"><i
                                                    class="{{ $btnDetail->icon }}"></i> Detail</button>
                                            </li>

                                            <a class="btn btn-secondary btn-sm" id="btnRestoreAc"
                                                href="{{ route('ac.restore', ['id' => $ac->id]) }}"><i
