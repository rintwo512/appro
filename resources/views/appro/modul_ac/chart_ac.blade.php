<x-main title="{{ $title }}">
                ...
                <div class="card-body">
                    ...
                    <div class="btn-toolbar mb-3" role="toolbar" aria-label="Toolbar with button groups">
                        <div class="btn-group me-2 mb-2" role="group" aria-label="First group">
                            ...
                            <button type="buttton" class="btn btn-secondary" data-bs-toggle="modal"
                                data-bs-target="#modalTambahChart" id="btnTambahChartAc">
                        ...
                        <x-tbody>
                            @foreach ($data as $chart)
                                <tr id="idchart{{ $chart->id }}">
                                    ...
                                    <td>{{ $chart->total }}</td>
                                    <td>
                                        <button type="button" id="btnEditChart" class="border-0 bg-transparent"
                                            data-bs-toggle="modal" data-bs-target="#modalUpdateChart"
                                            data-idchart="{{ $chart->id }}" data-tahunchart="{{ $chart->tahun }}"
    ...
    @include('components.AC.ac-modal-chart-cari')
</x-main>
